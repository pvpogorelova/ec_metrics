...
xi_crit # так как наблюдаемое значение статистики больше критического, то на 5% уровне мы не можем отвергнуть гипотезу
# H1, тогда нужно сравнить RSS моделей:
deviance(model1)
deviance(model2) # так как у полулогарифмической модели RSS меньше, то выбираем ее
